...
import { FormRowComponent,FormFileComponent,TextAreaComponent } from '../components'
...
const Profiles = () => {
  ...
  const {firstName,email,lastName,profile} = user
  return (
    <Wrapper>
      ...
      encType='multipart/form-data'>
        ...
        <TextAreaComponent type='text' name='profile' defaultValue={profile}/>
